class ColNames:
    ...
    TECHNICAL_COLS = [RSI, MACD, MACD_SIG, SMA_20, SMA_50, BB_LOWER, BB_UPPER]
    TECHNICAL_COLS_NORM = [RSI_NORM, MACD_NORM, MACD_SIG_NORM, SMA_20_NORM, SMA_50_NORM, BB_LOWER_NORM, BB_UPPER_NORM]
